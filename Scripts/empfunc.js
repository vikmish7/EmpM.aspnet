...
$(document).ready(function () {
    ...
    //     if (!value) {
    //         input.css('border', '1px solid red'); // Red border for invalid input
    //     } else {
    //         input.css('border', '1px solid green'); // Green border for valid input
    //     }
    // };
    ...
    //         validateInput($(this));
    //     })
    //     // On focus: Show current validation state without resetting
    //     .on('focus', function () {
    //         const input = $(this);
    //         const value = input.val()?.trim();
    //         if (!value) {
    //             input.css('border', '1px solid red'); // Keep red if empty
    //         } else {
    //             input.css('border', '1px solid green'); // Keep green if valid
    //         }
    //     });
